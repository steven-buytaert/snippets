...
static const CoI_t CoI_0[204] = {
  ...
  INFO(    7.7.32 ,  25) { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num =  3, .skip = 3 }, { .num =  2, .skip = 2 }, { .action = copyws, .inst = 1 }, { .LSB = 0x10 }, { .MSB = 0x00 }, 
  INFO( 7.7.65.36 ,  32) { .num =  7 }, 
  INFO(     7.7.2 ,  33) { .num =  4 }, { .action = loop, .inst = 1 }, { .num =  7, .skip = 1 }, { .num =  5, .skip = 1 }, { .num =  2 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.7.33 ,  39) { .num =  4 }, { .action = loop, .inst = 1 }, { .num = 11, .skip = 1 }, { .num =  3, .skip = 1 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.7.22 ,  44) { .num =  9 }, 
  INFO( 7.7.65.19 ,  45) { .num = 12 }, 
  INFO(  7.7.65.2 ,  46) { .num =  5, .skip = 3 }, { .action = loop, .inst = 1 }, { .num =  9, .skip = 7 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .num =  1, .skip = 7 }, { .action = endloop, .inst = 1 }, 
  INFO( 7.7.65.18 ,  52) { .num =  9, .skip = 1 }, 
  INFO( 7.7.65.29 ,  53) { .num = 13, .skip = 1 }, { .num =  5, .skip = 1 }, { .action = inlinefix, .inst = 1 }, { .num =  2 }, 
  INFO( 7.7.65.16 ,  57) { .num =  6 }, 
  INFO( 7.7.65.34 ,  58) { .num = 13, .skip = 1 }, { .num =  5, .skip = 1 }, { .num =  5, .skip = 1 }, 
  INFO( 7.7.65.25 ,  61) { .num =  5, .skip = 1 }, { .action = copyws, .arg = 1, .inst = 1 }, { .LSB = 0x15 }, { .MSB = 0x00 }, { .num =  6 }, 
  INFO(  7.7.65.1 ,  66) { .num =  5, .skip = 1 }, { .action = copyws, .arg = 1, .inst = 1 }, { .LSB = 0x11 }, { .MSB = 0x00 }, 
  INFO( 7.7.65.22 ,  70) { .num =  1 }, { .action = loop, .inst = 1 }, { .num =  2 }, { .action = endloop, .inst = 1 }, 
  INFO(  7.7.65.3 ,  74) { .num =  5, .skip = 1 }, { .num =  8 }, 
  INFO( 7.7.65.21 ,  76) { .num =  7, .skip = 1 }, { .num =  9 }, { .action = loop, .inst = 1 }, { .num =  2 }, { .action = endloop, .inst = 1 }, 
  INFO( 7.7.65.27 ,  81) { .action = copyws, .arg = 1, .inst = 1 }, { .LSB = 0x11 }, { .MSB = 0x00 }, { .num =  5, .skip = 1 }, { .action = inlinefix, .inst = 1 }, { .num =  2 }, 
  INFO(  7.7.65.6 ,  87) { .num = 14 }, 
  INFO( 7.7.65.11 ,  88) { .num =  5 }, { .action = loop, .inst = 1 }, { .action = copyws, .inst = 1 }, { .LSB = 0x10 }, { .MSB = 0x00 }, { .action = endloop, .inst = 1 }, 
  INFO( 7.7.65.10 ,  94) { .num =  5, .skip = 1 }, { .action = copyws, .inst = 1 }, { .LSB = 0x20 }, { .MSB = 0x00 }, 
  INFO( 7.7.65.10 ,  98) { .num =  5, .skip = 1 }, { .action = copyws, .arg = 1, .inst = 1 }, { .LSB = 0x1d }, { .MSB = 0x00 }, 
  INFO( 7.7.65.13 , 102) { .num =  5, .skip = 3 }, { .action = loop, .inst = 1 }, { .num =  8 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .action = endloop, .inst = 1 }, 
  INFO(  7.7.65.9 , 107) { .action = copyws, .inst = 1 }, { .LSB = 0x25 }, { .MSB = 0x00 }, 
  INFO( 7.7.65.15 , 110) { .num =  9, .skip = 1 }, { .num =  5 }, { .action = inlinefix, .inst = 1 }, 
  INFO( 7.7.65.37 , 113) { .num =  8 }, { .action = loop, .inst = 1 }, { .num =  6, .skip = 2 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .action = endloop, .inst = 1 }, 
  INFO( 7.7.65.14 , 118) { .num =  5, .skip = 1 }, { .num = 11, .skip = 1 }, { .num =  7, .skip = 1 }, 
  INFO( 7.7.65.14 , 121) { .num =  5, .skip = 1 }, { .num = 11, .skip = 1 }, { .num =  3, .skip = 1 }, 
  INFO( 7.7.65.24 , 124) { .num =  5, .skip = 1 }, { .num = 15, .skip = 1 }, { .num =  7, .skip = 1 }, 
  INFO( 7.7.65.24 , 127) { .num =  5, .skip = 1 }, { .num = 15, .skip = 1 }, { .num =  3, .skip = 1 }, 
  INFO( 7.7.65.12 , 130) { .num =  5, .skip = 1 }, { .num =  4 }, 
  INFO(  7.7.65.8 , 132) { .action = copyws, .inst = 1 }, { .LSB = 0x45 }, { .MSB = 0x00 }, 
  INFO(  7.7.65.4 , 135) { .num =  5, .skip = 1 }, { .num = 10 }, 
  INFO( 7.7.65.31 , 137) { .num =  5, .skip = 1 }, { .num =  3, .skip = 1 }, 
  INFO( 7.7.65.33 , 139) { .num =  5, .skip = 1 }, { .num =  7, .skip = 1 }, 
  INFO(    7.7.24 , 141) { .action = copyws, .inst = 1 }, { .LSB = 0x1a }, { .MSB = 0x00 }, 
  INFO(    7.7.46 , 144) { .num =  3, .skip = 1 }, { .num =  4 }, 
  INFO(    7.7.25 , 146) { .num =  3 }, 
  INFO(    7.7.27 , 147) { .num =  3, .skip = 1 }, { .num =  3, .skip = 1 }, 
  INFO(    7.7.20 , 149) { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  2 }, 
  INFO(    7.7.59 , 153) { .num =  3, .skip = 1 }, { .num =  3, .skip = 1 }, { .action = loop, .inst = 1 }, { .num =  6 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.7.19 , 158) { .num =  4 }, { .action = loop, .inst = 1 }, { .num =  4 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.7.13 , 162) { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num =  4, .skip = 2 }, { .action = copyws, .inst = 1 }, { .LSB = 0x10 }, { .MSB = 0x00 }, 
  INFO(    7.7.34 , 168) { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num = 12 }, 
  INFO(    7.7.12 , 171) { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  4 }, 
  INFO(    7.7.50 , 175) { .action = copyws, .inst = 1 }, { .LSB = 0x11 }, { .MSB = 0x00 }, 
  INFO(     7.7.7 , 178) { .action = copyws, .inst = 1 }, { .LSB = 0x01 }, { .MSB = 0x01 }, 
  INFO(    7.7.21 , 181) { .num =  4 }, { .action = loop, .inst = 1 }, { .action = copyws, .inst = 1 }, { .LSB = 0x16 }, { .MSB = 0x00 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.7.76 , 187) { .num =  3, .skip = 1 }, { .num =  8 }, 
  INFO(    7.7.68 , 189) { .num =  9, .skip = 2 }, { .num = 15, .skip = 1 }, { .num =  7, .skip = 1 }, 
  INFO(    7.7.36 , 192) { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num =  8 }, 
  INFO(    7.7.35 , 195) { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num = 11, .skip = 1 }, { .num =  5, .skip = 1 }, 
  INFO(    7.7.66 , 199) { .num =  3, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  6, .skip = 2 }, 
  INFO(    7.7.42 , 202) { .num =  9, .skip = 3 }, { .num =  4 }, 
};

static const TE_t TE_0[103] = {
  { .code = 0x01, .issub = 0, .coistart =  13, .numcoi = 1 }, //   0 7.7.1      p HCI_Inquiry_Complete
  { .code = 0x01, .issub = 1, .coistart =  66, .numcoi = 4 }, //   1 7.7.65.1     HCI_LE_Connection_Complete
  { .code = 0x02, .issub = 0, .coistart =  33, .numcoi = 6 }, //   2 7.7.2        HCI_Inquiry_Result
  { .code = 0x02, .issub = 1, .coistart =  46, .numcoi = 6 }, //   3 7.7.65.2     HCI_LE_Advertising_Report
  { .code = 0x03, .issub = 0, .coistart =   8, .numcoi = 3 }, //   4 7.7.3        HCI_Connection_Complete
  { .code = 0x03, .issub = 1, .coistart =  74, .numcoi = 2 }, //   5 7.7.65.3     HCI_LE_Connection_Update_Complete
  { .code = 0x04, .issub = 0, .coistart =  14, .numcoi = 1 }, //   6 7.7.4        HCI_Connection_Request
  { .code = 0x04, .issub = 1, .coistart = 135, .numcoi = 2 }, //   7 7.7.65.4     HCI_LE_Read_Remote_Features_Complete
  { .code = 0x05, .issub = 0, .coistart =  18, .numcoi = 3 }, //   8 7.7.5        HCI_Disconnection_Complete
  { .code = 0x05, .issub = 1, .coistart =  29, .numcoi = 3 }, //   9 7.7.65.5     HCI_LE_Long_Term_Key_Request
  { .code = 0x06, .issub = 0, .coistart =   3, .numcoi = 3 }, //  10 7.7.6      p HCI_Authentication_Complete
  { .code = 0x06, .issub = 1, .coistart =  87, .numcoi = 1 }, //  11 7.7.65.6     HCI_LE_Remote_Connection_Parameter_Request
  { .code = 0x07, .issub = 0, .coistart = 178, .numcoi = 3 }, //  12 7.7.7        HCI_Remote_Name_Request_Complete
  { .code = 0x07, .issub = 1, .coistart =  87, .numcoi = 1 }, //  13 7.7.65.7     HCI_LE_Data_Length_Change
  { .code = 0x08, .issub = 0, .coistart =  18, .numcoi = 3 }, //  14 7.7.8        HCI_Encryption_Change [v1]
  { .code = 0x08, .issub = 1, .coistart = 132, .numcoi = 3 }, //  15 7.7.65.8     HCI_LE_Read_Local_P-256_Public_Key_Complete
  { .code = 0x09, .issub = 0, .coistart =   3, .numcoi = 3 }, //  16 7.7.9      p HCI_Change_Connection_Link_Key_Complete
  { .code = 0x09, .issub = 1, .coistart = 107, .numcoi = 3 }, //  17 7.7.65.9     HCI_LE_Generate_DHKey_Complete
  { .code = 0x0a, .issub = 0, .coistart =  18, .numcoi = 3 }, //  18 7.7.10       HCI_Link_Key_Type_Changed
  { .code = 0x0a, .issub = 1, .coistart =  98, .numcoi = 4 }, //  19 7.7.65.10    HCI_LE_Enhanced_Connection_Complete [v1]
  { .code = 0x0b, .issub = 0, .coistart =   8, .numcoi = 3 }, //  20 7.7.11       HCI_Read_Remote_Supported_Features_Complete
  { .code = 0x0b, .issub = 1, .coistart =  88, .numcoi = 6 }, //  21 7.7.65.11    HCI_LE_Directed_Advertising_Report
  { .code = 0x0c, .issub = 0, .coistart = 171, .numcoi = 4 }, //  22 7.7.12       HCI_Read_Remote_Version_Information_Complete
  { .code = 0x0c, .issub = 1, .coistart = 130, .numcoi = 2 }, //  23 7.7.65.12    HCI_LE_PHY_Update_Complete
  { .code = 0x0d, .issub = 0, .coistart = 162, .numcoi = 6 }, //  24 7.7.13       HCI_QoS_Setup_Complete
  { .code = 0x0d, .issub = 1, .coistart = 102, .numcoi = 5 }, //  25 7.7.65.13    HCI_LE_Extended_Advertising_Report
  { .code = 0x0e, .issub = 0, .coistart =   0, .numcoi = 1 }, //  26 7.7.14       HCI_Command_Complete
  { .code = 0x0e, .issub = 1, .coistart = 121, .numcoi = 3 }, //  27 7.7.65.14    HCI_LE_Periodic_Advertising_Sync_Established [v1]
  ...
  { .code = 0x10, .issub = 1, .coistart =  57, .numcoi = 1 }, //  31 7.7.65.16    HCI_LE_Periodic_Advertising_Sync_Lost
  ...
  { .code = 0x12, .issub = 1, .coistart =  52, .numcoi = 1 }, //  35 7.7.65.18    HCI_LE_Advertising_Set_Terminated
  { .code = 0x13, .issub = 0, .coistart = 158, .numcoi = 4 }, //  36 7.7.19       HCI_Number_Of_Completed_Packets
  { .code = 0x13, .issub = 1, .coistart =  45, .numcoi = 1 }, //  37 7.7.65.19    HCI_LE_Scan_Request_Received
  { .code = 0x14, .issub = 0, .coistart = 149, .numcoi = 4 }, //  38 7.7.20       HCI_Mode_Change
  { .code = 0x14, .issub = 1, .coistart =  35, .numcoi = 1 }, //  39 7.7.65.20    HCI_LE_Channel_Selection_Algorithm
  { .code = 0x15, .issub = 0, .coistart = 181, .numcoi = 6 }, //  40 7.7.21       HCI_Return_Link_Keys
  { .code = 0x15, .issub = 1, .coistart =  76, .numcoi = 5 }, //  41 7.7.65.21    HCI_LE_Connectionless_IQ_Report
  { .code = 0x16, .issub = 0, .coistart =  44, .numcoi = 1 }, //  42 7.7.22       HCI_PIN_Code_Request
  { .code = 0x16, .issub = 1, .coistart =  70, .numcoi = 4 }, //  43 7.7.65.22    HCI_LE_Connection_IQ_Report
  { .code = 0x17, .issub = 0, .coistart =  44, .numcoi = 1 }, //  44 7.7.23       HCI_Link_Key_Request
  { .code = 0x17, .issub = 1, .coistart =   6, .numcoi = 2 }, //  45 7.7.65.23    HCI_LE_CTE_Request_Failed
  { .code = 0x18, .issub = 0, .coistart = 141, .numcoi = 3 }, //  46 7.7.24       HCI_Link_Key_Notification
  { .code = 0x18, .issub = 1, .coistart = 127, .numcoi = 3 }, //  47 7.7.65.24    HCI_LE_Periodic_Advertising_Sync_Transfer_Received [v1]
  { .code = 0x19, .issub = 0, .coistart = 146, .numcoi = 1 }, //  48 7.7.25       HCI_Loopback_Command
  { .code = 0x19, .issub = 1, .coistart =  61, .numcoi = 5 }, //  49 7.7.65.25    HCI_LE_CIS_Established
  ...
  { .code = 0x1b, .issub = 0, .coistart = 147, .numcoi = 2 }, //  52 7.7.27       HCI_Max_Slots_Change
  { .code = 0x1b, .issub = 1, .coistart =  81, .numcoi = 6 }, //  53 7.7.65.27    HCI_LE_Create_BIG_Complete
  { .code = 0x1c, .issub = 0, .coistart =  11, .numcoi = 3 }, //  54 7.7.28       HCI_Read_Clock_Offset_Complete
  { .code = 0x1c, .issub = 1, .coistart =  57, .numcoi = 1 }, //  55 7.7.65.28    HCI_LE_Terminate_BIG_Complete
  { .code = 0x1d, .issub = 0, .coistart =  11, .numcoi = 3 }, //  56 7.7.29       HCI_Connection_Packet_Type_Changed
  { .code = 0x1d, .issub = 1, .coistart =  53, .numcoi = 4 }, //  57 7.7.65.29    HCI_LE_BIG_Sync_Established
  { .code = 0x1e, .issub = 0, .coistart =   1, .numcoi = 2 }, //  58 7.7.30       HCI_QoS_Violation
  { .code = 0x1e, .issub = 1, .coistart =  57, .numcoi = 1 }, //  59 7.7.65.30    HCI_LE_BIG_Sync_Lost
  { .code = 0x1f, .issub = 1, .coistart = 137, .numcoi = 2 }, //  60 7.7.65.31    HCI_LE_Request_Peer_SCA_Complete
  { .code = 0x20, .issub = 0, .coistart =  10, .numcoi = 1 }, //  61 7.7.31       HCI_Page_Scan_Repetition_Mode_Change
  { .code = 0x20, .issub = 1, .coistart =  75, .numcoi = 1 }, //  62 7.7.65.32    HCI_LE_Path_Loss_Threshold
  { .code = 0x21, .issub = 0, .coistart =  25, .numcoi = 7 }, //  63 7.7.32       HCI_Flow_Specification_Complete
  { .code = 0x21, .issub = 1, .coistart = 139, .numcoi = 2 }, //  64 7.7.65.33    HCI_LE_Transmit_Power_Reporting
  { .code = 0x22, .issub = 0, .coistart =  39, .numcoi = 5 }, //  65 7.7.33       HCI_Inquiry_Result_with_RSSI
  { .code = 0x22, .issub = 1, .coistart =  58, .numcoi = 3 }, //  66 7.7.65.34    HCI_LE_BIGInfo_Advertising_Report
  { .code = 0x23, .issub = 0, .coistart = 168, .numcoi = 3 }, //  67 7.7.34       HCI_Read_Remote_Extended_Features_Complete
  { .code = 0x23, .issub = 1, .coistart = 135, .numcoi = 2 }, //  68 7.7.65.35    HCI_LE_Subrate_Change
  { .code = 0x24, .issub = 1, .coistart = 118, .numcoi = 3 }, //  69 7.7.65.14    HCI_LE_Periodic_Advertising_Sync_Established [v2]
  { .code = 0x25, .issub = 1, .coistart = 110, .numcoi = 3 }, //  70 7.7.65.15    HCI_LE_Periodic_Advertising_Report [v2]
  { .code = 0x26, .issub = 1, .coistart = 124, .numcoi = 3 }, //  71 7.7.65.24    HCI_LE_Periodic_Advertising_Sync_Transfer_Received [v2]
  { .code = 0x27, .issub = 1, .coistart =  32, .numcoi = 1 }, //  72 7.7.65.36    HCI_LE_Periodic_Advertising_Subevent_Data_Request
  { .code = 0x28, .issub = 1, .coistart = 113, .numcoi = 5 }, //  73 7.7.65.37    HCI_LE_Periodic_Advertising_Response_Report
  { .code = 0x29, .issub = 1, .coistart =  94, .numcoi = 4 }, //  74 7.7.65.10    HCI_LE_Enhanced_Connection_Complete [v2]
  { .code = 0x2c, .issub = 0, .coistart = 195, .numcoi = 4 }, //  75 7.7.35       HCI_Synchronous_Connection_Complete
  { .code = 0x2d, .issub = 0, .coistart = 192, .numcoi = 3 }, //  76 7.7.36       HCI_Synchronous_Connection_Changed
  ...
  { .code = 0x31, .issub = 0, .coistart =  44, .numcoi = 1 }, //  80 7.7.40       HCI_IO_Capability_Request
  { .code = 0x32, .issub = 0, .coistart =  45, .numcoi = 1 }, //  81 7.7.41       HCI_IO_Capability_Response
  { .code = 0x33, .issub = 0, .coistart = 202, .numcoi = 2 }, //  82 7.7.42       HCI_User_Confirmation_Request
  { .code = 0x34, .issub = 0, .coistart =  44, .numcoi = 1 }, //  83 7.7.43       HCI_User_Passkey_Request
  { .code = 0x35, .issub = 0, .coistart =  44, .numcoi = 1 }, //  84 7.7.44       HCI_Remote_OOB_Data_Request
  { .code = 0x36, .issub = 0, .coistart =  10, .numcoi = 1 }, //  85 7.7.45     p HCI_Simple_Pairing_Complete
  { .code = 0x38, .issub = 0, .coistart = 144, .numcoi = 2 }, //  86 7.7.46       HCI_Link_Supervision_Timeout_Changed
  { .code = 0x39, .issub = 0, .coistart =   1, .numcoi = 2 }, //  87 7.7.47       HCI_Enhanced_Flush_Complete
  { .code = 0x3b, .issub = 0, .coistart = 202, .numcoi = 2 }, //  88 7.7.48       HCI_User_Passkey_Notification
  { .code = 0x3c, .issub = 0, .coistart =  10, .numcoi = 1 }, //  89 7.7.49       HCI_Keypress_Notification
  { .code = 0x3d, .issub = 0, .coistart = 175, .numcoi = 3 }, //  90 7.7.50       HCI_Remote_Host_Supported_Features_Notification
  { .code = 0x48, .issub = 0, .coistart = 153, .numcoi = 5 }, //  91 7.7.59       HCI_Number_Of_Completed_Data_Blocks
  { .code = 0x4e, .issub = 0, .coistart = 199, .numcoi = 3 }, //  92 7.7.66       HCI_Triggered_Clock_Capture
  { .code = 0x4f, .issub = 0, .coistart =  13, .numcoi = 1 }, //  93 7.7.67     p HCI_Synchronization_Train_Complete
  { .code = 0x50, .issub = 0, .coistart = 189, .numcoi = 3 }, //  94 7.7.68       HCI_Synchronization_Train_Received
...
static const CoI_t CoI_2[40] = {
  INFO(     7.2.3 ,   0) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  2 }, 
  INFO(    7.2.13 ,   3) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  3, .skip = 3 }, { .num =  2, .skip = 2 }, { .action = copyws, .inst = 1 }, { .LSB = 0x10 }, { .MSB = 0x00 }, 
  INFO(     7.2.1 ,  10) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  6 }, 
  INFO(     7.2.6 ,  13) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  4, .skip = 2 }, { .action = copyws, .inst = 1 }, { .LSB = 0x10 }, { .MSB = 0x00 }, 
  INFO(    7.2.10 ,  19) { .num =  7, .skip = 1 }, { .num =  2 }, 
  INFO(     7.2.7 ,  21) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  2 }, 
  INFO(     7.2.9 ,  24) { .num =  7, .skip = 1 }, { .num =  4 }, 
  INFO(     7.2.7 ,  26) { .num =  7, .skip = 1 }, { .num =  3, .skip = 1 }, 
  INFO(     7.2.2 ,  28) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num = 10 }, 
  INFO(    7.2.14 ,  31) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  8 }, 
  INFO(     7.2.8 ,  34) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  7, .skip = 1 }, 
  INFO(    7.2.10 ,  37) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  4 }, 
};

static const TE_t TE_2[18] = {
  { .OCF = 0x01, .isret = 0, .coistart =  10, .numcoi = 3 }, //   0 7.2.1        HCI_Hold_Mode
  { .OCF = 0x03, .isret = 0, .coistart =  28, .numcoi = 3 }, //   1 7.2.2        HCI_Sniff_Mode
  { .OCF = 0x04, .isret = 0, .coistart =   0, .numcoi = 3 }, //   2 7.2.3      p HCI_Exit_Sniff_Mode
  { .OCF = 0x07, .isret = 0, .coistart =  13, .numcoi = 6 }, //   3 7.2.6        HCI_QoS_Setup
  { .OCF = 0x09, .isret = 0, .coistart =  21, .numcoi = 3 }, //   4 7.2.7      p HCI_Role_Discovery
  { .OCF = 0x09, .isret = 1, .coistart =  26, .numcoi = 2 }, //   5 7.2.7        HCI_Role_Discovery
  { .OCF = 0x0b, .isret = 0, .coistart =  34, .numcoi = 3 }, //   6 7.2.8        HCI_Switch_Role
  { .OCF = 0x0c, .isret = 0, .coistart =  21, .numcoi = 3 }, //   7 7.2.9      p HCI_Read_Link_Policy_Settings
  { .OCF = 0x0c, .isret = 1, .coistart =  24, .numcoi = 2 }, //   8 7.2.9        HCI_Read_Link_Policy_Settings
  { .OCF = 0x0d, .isret = 0, .coistart =  37, .numcoi = 3 }, //   9 7.2.10       HCI_Write_Link_Policy_Settings
  { .OCF = 0x0d, .isret = 1, .coistart =  19, .numcoi = 2 }, //  10 7.2.10     p HCI_Write_Link_Policy_Settings
  { .OCF = 0x0e, .isret = 0, .coistart =   3, .numcoi = 2 }, //  11 7.2.11     s HCI_Read_Default_Link_Policy_Settings
  { .OCF = 0x0e, .isret = 1, .coistart =  19, .numcoi = 2 }, //  12 7.2.11       HCI_Read_Default_Link_Policy_Settings
  { .OCF = 0x0f, .isret = 0, .coistart =  21, .numcoi = 3 }, //  13 7.2.12       HCI_Write_Default_Link_Policy_Settings
  { .OCF = 0x0f, .isret = 1, .coistart =  19, .numcoi = 1 }, //  14 7.2.12     p HCI_Write_Default_Link_Policy_Settings
  { .OCF = 0x10, .isret = 0, .coistart =   3, .numcoi = 7 }, //  15 7.2.13       HCI_Flow_Specification
  { .OCF = 0x11, .isret = 0, .coistart =  31, .numcoi = 3 }, //  16 7.2.14       HCI_Sniff_Subrating
  { .OCF = 0x11, .isret = 1, .coistart =  19, .numcoi = 2 }, //  17 7.2.14     p HCI_Sniff_Subrating
};

static const CodecTab_t CodecTab_2 = {
  .numtab = 18, .numcoi = 40, .table = TE_2, .CoI = CoI_2
};
...
static const CoI_t CoI_4[38] = {
  ...
  INFO(    7.4.10 ,  17) { .num =  8 }, { .action = loop, .inst = 1 }, { .num =  1, .skip = 7 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .action = endloop, .inst = 1 }, 
  INFO(     7.4.8 ,  22) { .num =  8 }, { .action = laterfix, .arg = 2, .inst = 1 }, { .num =  1, .skip = 7 }, 
  INFO(     7.4.8 ,  25) { .num =  8 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .num =  2, .skip = 6 }, 
...
static const CoI_t CoI_5[24] = {
  ...
  INFO(    7.5.11 ,   2) { .num =  8 }, { .action = loop, .inst = 1 }, { .num =  2, .skip = 6 }, { .action = laterfix, .arg = 8, .inst = 1 }, { .action = endloop, .inst = 1 }, 
...
static const CoI_t CoI_8[235] = {
  ...
  INFO(    7.8.66 ,  65) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num = 12 }, { .action = modif, .inst = 1 }, { .action = loop, .inst = 1 }, { .num =  8 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.8.66 ,  72) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num = 10 }, { .action = modif, .inst = 1 }, { .action = loop, .inst = 1 }, { .num =  8 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.8.37 ,  79) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .action = copyws, .arg = 1, .inst = 1 }, { .LSB = 0x41 }, { .MSB = 0x00 }, 
  INFO(    7.8.37 ,  84) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .action = copyws, .inst = 1 }, { .LSB = 0x40 }, { .MSB = 0x00 }, 
  INFO(    7.8.11 ,  89) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  2 }, 
  INFO(   7.8.113 ,  92) { .num =  7, .skip = 1 }, { .num =  2, .skip = 2 }, { .num = 12 }, 
  INFO(    7.8.25 ,  95) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .action = copyws, .inst = 1 }, { .LSB = 0x12 }, { .MSB = 0x00 }, 
  INFO(    7.8.67 , 100) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  9, .skip = 1 }, { .num =  5, .skip = 1 }, 
  INFO(    7.8.19 , 104) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  5, .skip = 1 }, 
  INFO(     7.8.4 , 107) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  6 }, 
  INFO(     7.8.2 , 110) { .num =  7, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  3, .skip = 1 }, 
  INFO(    7.8.20 , 113) { .num =  7, .skip = 1 }, { .num =  7, .skip = 1 }, 
  INFO(   7.8.116 , 115) { .num =  7, .skip = 1 }, { .num =  2, .skip = 2 }, { .action = copyws, .inst = 1 }, { .LSB = 0x1c }, { .MSB = 0x00 }, 
  INFO(    7.8.96 , 120) { .num =  7, .skip = 1 }, { .num = 11, .skip = 1 }, 
  INFO(    7.8.46 , 122) { .num =  7, .skip = 1 }, { .num =  8 }, 
  INFO(    7.8.34 , 124) { .num =  7, .skip = 1 }, { .num =  4 }, 
  INFO(    7.8.28 , 126) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  7 }, { .action = inlinefix, .inst = 1 }, { .num =  1, .skip = 1 }, 
  INFO(     7.8.5 , 131) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num = 15, .skip = 1 }, 
  INFO(    7.8.97 , 134) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num = 15, .skip = 1 }, { .action = loop, .inst = 1 }, { .num =  1, .skip = 1 }, { .num =  8 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.8.97 , 141) { .num =  9, .skip = 1 }, { .action = inlinefix, .inst = 1 }, { .num =  2 }, 
  INFO(    7.8.98 , 144) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  9, .skip = 1 }, { .num =  6 }, { .action = loop, .inst = 1 }, { .num = 14 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.8.80 , 151) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  5 }, { .action = inlinefix, .inst = 1 }, { .num =  1, .skip = 1 }, 
  INFO(    7.8.84 , 156) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  4 }, { .action = inlinefix, .inst = 1 }, { .num =  1, .skip = 1 }, 
  INFO(    7.8.82 , 161) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  6 }, { .action = inlinefix, .inst = 1 }, { .num =  1, .skip = 1 }, 
  INFO(    7.8.92 , 166) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num =  5, .skip = 1 }, 
  INFO(    7.8.56 , 170) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  2 }, { .action = loop, .inst = 1 }, { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.8.53 , 177) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .action = copyws, .inst = 1 }, { .LSB = 0x1a }, { .MSB = 0x00 }, 
  INFO(    7.8.53 , 183) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .action = copyws, .inst = 1 }, { .LSB = 0x18 }, { .MSB = 0x00 }, 
  INFO(    7.8.64 , 189) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  3 }, { .action = modif, .inst = 1 }, { .action = loop, .inst = 1 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.8.62 , 195) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  3 }, { .action = inlinefix, .inst = 1 }, 
  INFO(    7.8.61 , 199) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num = 11, .skip = 1 }, 
  INFO(    7.8.10 , 203) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  1, .skip = 1 }, { .num =  6 }, 
  INFO(   7.8.126 , 207) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  8 }, { .action = inlinefix, .inst = 1 }, 
  INFO(   7.8.125 , 211) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  2 }, { .action = loop, .inst = 1 }, { .num =  4, .skip = 4 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .action = endloop, .inst = 1 }, 
  INFO(    7.8.91 , 218) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  5, .skip = 1 }, 
  INFO(    7.8.49 , 222) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  5, .skip = 1 }, { .num =  2 }, 
  INFO(   7.8.109 , 226) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num = 13 }, { .action = inlinefix, .inst = 1 }, 
  INFO(    7.8.29 , 230) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  7, .skip = 3 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .num =  2, .skip = 6 }, 
};
...
static const TE_t TE_8[242] = {
  ...
  { .OCF = 0x02, .isret = 1, .coistart = 110, .numcoi = 2 }, //   3 7.8.2        HCI_LE_Read_Buffer_Size [v1]
  ...
  { .OCF = 0x05, .isret = 0, .coistart = 107, .numcoi = 3 }, //   6 7.8.4        HCI_LE_Set_Random_Address
  { .OCF = 0x05, .isret = 1, .coistart =   5, .numcoi = 1 }, //   7 7.8.4      p HCI_LE_Set_Random_Address
  { .OCF = 0x06, .isret = 0, .coistart = 131, .numcoi = 3 }, //   8 7.8.5        HCI_LE_Set_Advertising_Parameters
  ...
  { .OCF = 0x0b, .isret = 0, .coistart = 203, .numcoi = 4 }, //  18 7.8.10       HCI_LE_Set_Scan_Parameters
  { .OCF = 0x0b, .isret = 1, .coistart =   5, .numcoi = 1 }, //  19 7.8.10     p HCI_LE_Set_Scan_Parameters
  { .OCF = 0x0c, .isret = 0, .coistart =  89, .numcoi = 3 }, //  20 7.8.11       HCI_LE_Set_Scan_Enable
  ...
  { .OCF = 0x14, .isret = 0, .coistart = 104, .numcoi = 3 }, //  34 7.8.19       HCI_LE_Set_Host_Channel_Classification
  { .OCF = 0x14, .isret = 1, .coistart =   5, .numcoi = 1 }, //  35 7.8.19     p HCI_LE_Set_Host_Channel_Classification
  { .OCF = 0x15, .isret = 0, .coistart =  89, .numcoi = 3 }, //  36 7.8.20     p HCI_LE_Read_Channel_Map
  { .OCF = 0x15, .isret = 1, .coistart = 113, .numcoi = 2 }, //  37 7.8.20       HCI_LE_Read_Channel_Map
  { .OCF = 0x16, .isret = 0, .coistart =  89, .numcoi = 3 }, //  38 7.8.21     p HCI_LE_Read_Remote_Features
  ...
  { .OCF = 0x1a, .isret = 0, .coistart =  95, .numcoi = 5 }, //  44 7.8.25       HCI_LE_Long_Term_Key_Request_Reply
  { .OCF = 0x1a, .isret = 1, .coistart =  24, .numcoi = 2 }, //  45 7.8.25     p HCI_LE_Long_Term_Key_Request_Reply
  { .OCF = 0x1b, .isret = 0, .coistart =  89, .numcoi = 3 }, //  46 7.8.26     p HCI_LE_Long_Term_Key_Request_Negative_Reply
  ...
  { .OCF = 0x22, .isret = 0, .coistart = 107, .numcoi = 3 }, //  60 7.8.33       HCI_LE_Set_Data_Length
  ...
  { .OCF = 0x23, .isret = 1, .coistart = 124, .numcoi = 2 }, //  63 7.8.34       HCI_LE_Read_Suggested_Default_Data_Length
  { .OCF = 0x24, .isret = 0, .coistart = 156, .numcoi = 3 }, //  64 7.8.35       HCI_LE_Write_Suggested_Default_Data_Length
  ...
  { .OCF = 0x26, .isret = 0, .coistart =  84, .numcoi = 5 }, //  67 7.8.37       HCI_LE_Generate_DHKey [v1]
  ...
  { .OCF = 0x2e, .isret = 0, .coistart =  89, .numcoi = 3 }, //  82 7.8.45       HCI_LE_Set_Resolvable_Private_Address_Timeout
  ...
  { .OCF = 0x2f, .isret = 1, .coistart = 122, .numcoi = 2 }, //  85 7.8.46       HCI_LE_Read_Maximum_Data_Length
  { .OCF = 0x30, .isret = 0, .coistart =  89, .numcoi = 3 }, //  86 7.8.47     p HCI_LE_Read_PHY
  { .OCF = 0x30, .isret = 1, .coistart = 124, .numcoi = 2 }, //  87 7.8.47       HCI_LE_Read_PHY
  ...
  { .OCF = 0x32, .isret = 0, .coistart = 222, .numcoi = 4 }, //  90 7.8.49       HCI_LE_Set_PHY
  ...
  { .OCF = 0x34, .isret = 0, .coistart = 156, .numcoi = 3 }, //  93 7.8.29       HCI_LE_Transmitter_Test [v2]
  ...
  { .OCF = 0x36, .isret = 0, .coistart = 183, .numcoi = 6 }, //  97 7.8.53       HCI_LE_Set_Extended_Advertising_Parameters [v1]
  { .OCF = 0x36, .isret = 1, .coistart =   8, .numcoi = 1 }, //  98 7.8.53       HCI_LE_Set_Extended_Advertising_Parameters [v1]
  { .OCF = 0x37, .isret = 0, .coistart = 156, .numcoi = 4 }, //  99 7.8.54       HCI_LE_Set_Extended_Advertising_Data
  { .OCF = 0x37, .isret = 1, .coistart =   5, .numcoi = 1 }, // 100 7.8.54     p HCI_LE_Set_Extended_Advertising_Data
  { .OCF = 0x38, .isret = 0, .coistart = 156, .numcoi = 4 }, // 101 7.8.55       HCI_LE_Set_Extended_Scan_Response_Data
  { .OCF = 0x38, .isret = 1, .coistart =   5, .numcoi = 1 }, // 102 7.8.55     p HCI_LE_Set_Extended_Scan_Response_Data
  { .OCF = 0x39, .isret = 0, .coistart = 170, .numcoi = 7 }, // 103 7.8.56       HCI_LE_Set_Extended_Advertising_Enable
  ...
  { .OCF = 0x3e, .isret = 0, .coistart = 203, .numcoi = 4 }, // 113 7.8.61       HCI_LE_Set_Periodic_Advertising_Parameters [v1]
  { .OCF = 0x3e, .isret = 1, .coistart =   5, .numcoi = 1 }, // 114 7.8.61     p HCI_LE_Set_Periodic_Advertising_Parameters [v1]
  { .OCF = 0x3f, .isret = 0, .coistart = 195, .numcoi = 4 }, // 115 7.8.62       HCI_LE_Set_Periodic_Advertising_Data
  { .OCF = 0x3f, .isret = 1, .coistart =   5, .numcoi = 1 }, // 116 7.8.62     p HCI_LE_Set_Periodic_Advertising_Data
  { .OCF = 0x40, .isret = 0, .coistart =  89, .numcoi = 3 }, // 117 7.8.63       HCI_LE_Set_Periodic_Advertising_Enable
  { .OCF = 0x40, .isret = 1, .coistart =   5, .numcoi = 1 }, // 118 7.8.63     p HCI_LE_Set_Periodic_Advertising_Enable
  { .OCF = 0x41, .isret = 0, .coistart = 189, .numcoi = 6 }, // 119 7.8.64       HCI_LE_Set_Extended_Scan_Parameters
  { .OCF = 0x41, .isret = 1, .coistart =   5, .numcoi = 1 }, // 120 7.8.64     p HCI_LE_Set_Extended_Scan_Parameters
  { .OCF = 0x42, .isret = 0, .coistart = 107, .numcoi = 3 }, // 121 7.8.65       HCI_LE_Set_Extended_Scan_Enable
  { .OCF = 0x42, .isret = 1, .coistart =   5, .numcoi = 1 }, // 122 7.8.65     p HCI_LE_Set_Extended_Scan_Enable
  { .OCF = 0x43, .isret = 0, .coistart =  72, .numcoi = 7 }, // 123 7.8.66       HCI_LE_Extended_Create_Connection [v1]
  { .OCF = 0x44, .isret = 0, .coistart = 100, .numcoi = 4 }, // 124 7.8.67       HCI_LE_Periodic_Advertising_Create_Sync
  ...
  { .OCF = 0x46, .isret = 0, .coistart =  89, .numcoi = 3 }, // 127 7.8.69       HCI_LE_Periodic_Advertising_Terminate_Sync
  ...
  { .OCF = 0x4c, .isret = 1, .coistart = 124, .numcoi = 2 }, // 140 7.8.75       HCI_LE_Read_RF_Path_Compensation
  { .OCF = 0x4d, .isret = 0, .coistart = 156, .numcoi = 3 }, // 141 7.8.76       HCI_LE_Write_RF_Path_Compensation
  ...
  { .OCF = 0x4f, .isret = 0, .coistart = 126, .numcoi = 5 }, // 145 7.8.28       HCI_LE_Receiver_Test [v3]
  { .OCF = 0x4f, .isret = 1, .coistart =   5, .numcoi = 1 }, // 146 7.8.28     p HCI_LE_Receiver_Test [v3]
  { .OCF = 0x50, .isret = 0, .coistart = 126, .numcoi = 5 }, // 147 7.8.29       HCI_LE_Transmitter_Test [v3]
  { .OCF = 0x50, .isret = 1, .coistart =   5, .numcoi = 1 }, // 148 7.8.29     p HCI_LE_Transmitter_Test [v3]
  { .OCF = 0x51, .isret = 0, .coistart = 151, .numcoi = 5 }, // 149 7.8.80       HCI_LE_Set_Connectionless_CTE_Transmit_Parameters
  { .OCF = 0x51, .isret = 1, .coistart =   5, .numcoi = 1 }, // 150 7.8.80     p HCI_LE_Set_Connectionless_CTE_Transmit_Parameters
  { .OCF = 0x52, .isret = 0, .coistart =  89, .numcoi = 3 }, // 151 7.8.81       HCI_LE_Set_Connectionless_CTE_Transmit_Enable
  { .OCF = 0x52, .isret = 1, .coistart =   5, .numcoi = 1 }, // 152 7.8.81     p HCI_LE_Set_Connectionless_CTE_Transmit_Enable
  { .OCF = 0x53, .isret = 0, .coistart = 161, .numcoi = 5 }, // 153 7.8.82       HCI_LE_Set_Connectionless_IQ_Sampling_Enable
  { .OCF = 0x53, .isret = 1, .coistart =  24, .numcoi = 2 }, // 154 7.8.82       HCI_LE_Set_Connectionless_IQ_Sampling_Enable
  { .OCF = 0x54, .isret = 0, .coistart = 151, .numcoi = 5 }, // 155 7.8.83       HCI_LE_Set_Connection_CTE_Receive_Parameters
  { .OCF = 0x54, .isret = 1, .coistart =  24, .numcoi = 2 }, // 156 7.8.83     p HCI_LE_Set_Connection_CTE_Receive_Parameters
  { .OCF = 0x55, .isret = 0, .coistart = 156, .numcoi = 5 }, // 157 7.8.84       HCI_LE_Set_Connection_CTE_Transmit_Parameters
  ...
  { .OCF = 0x5a, .isret = 0, .coistart = 107, .numcoi = 3 }, // 167 7.8.89       HCI_LE_Periodic_Advertising_Sync_Transfer
  { .OCF = 0x5a, .isret = 1, .coistart =  24, .numcoi = 2 }, // 168 7.8.89     p HCI_LE_Periodic_Advertising_Sync_Transfer
  { .OCF = 0x5b, .isret = 0, .coistart = 104, .numcoi = 3 }, // 169 7.8.90       HCI_LE_Periodic_Advertising_Set_Info_Transfer
  { .OCF = 0x5b, .isret = 1, .coistart =  24, .numcoi = 2 }, // 170 7.8.90     p HCI_LE_Periodic_Advertising_Set_Info_Transfer
  { .OCF = 0x5c, .isret = 0, .coistart = 218, .numcoi = 4 }, // 171 7.8.91       HCI_LE_Set_Periodic_Advertising_Sync_Transfer_Parameters
  { .OCF = 0x5c, .isret = 1, .coistart =  24, .numcoi = 2 }, // 172 7.8.91     p HCI_LE_Set_Periodic_Advertising_Sync_Transfer_Parameters
  { .OCF = 0x5d, .isret = 0, .coistart = 166, .numcoi = 4 }, // 173 7.8.92       HCI_LE_Set_Default_Periodic_Advertising_Sync_Transfer_Parameters
  { .OCF = 0x5d, .isret = 1, .coistart =   5, .numcoi = 1 }, // 174 7.8.92     p HCI_LE_Set_Default_Periodic_Advertising_Sync_Transfer_Parameters
  { .OCF = 0x5e, .isret = 0, .coistart =  79, .numcoi = 5 }, // 175 7.8.37       HCI_LE_Generate_DHKey [v2]
  ...
  { .OCF = 0x60, .isret = 1, .coistart = 110, .numcoi = 3 }, // 179 7.8.2        HCI_LE_Read_Buffer_Size [v2]
  { .OCF = 0x61, .isret = 0, .coistart =  89, .numcoi = 3 }, // 180 7.8.96     p HCI_LE_Read_ISO_TX_Sync
  { .OCF = 0x61, .isret = 1, .coistart = 120, .numcoi = 2 }, // 181 7.8.96       HCI_LE_Read_ISO_TX_Sync
  { .OCF = 0x62, .isret = 0, .coistart = 134, .numcoi = 7 }, // 182 7.8.97       HCI_LE_Set_CIG_Parameters
  { .OCF = 0x62, .isret = 1, .coistart = 141, .numcoi = 3 }, // 183 7.8.97       HCI_LE_Set_CIG_Parameters
  { .OCF = 0x63, .isret = 0, .coistart = 144, .numcoi = 7 }, // 184 7.8.98       HCI_LE_Set_CIG_Parameters_Test
  { .OCF = 0x63, .isret = 1, .coistart = 141, .numcoi = 3 }, // 185 7.8.98       HCI_LE_Set_CIG_Parameters_Test
  ...
  { .OCF = 0x6a, .isret = 0, .coistart =  89, .numcoi = 3 }, // 194 7.8.105      HCI_LE_Terminate_BIG
  ...
  { .OCF = 0x6d, .isret = 0, .coistart =  89, .numcoi = 3 }, // 198 7.8.108    p HCI_LE_Request_Peer_SCA
  { .OCF = 0x6e, .isret = 0, .coistart = 226, .numcoi = 4 }, // 199 7.8.109      HCI_LE_Setup_ISO_Data_Path
  ...
  { .OCF = 0x72, .isret = 0, .coistart =  89, .numcoi = 3 }, // 207 7.8.113    p HCI_LE_ISO_Read_Test_Counters
  { .OCF = 0x72, .isret = 1, .coistart =  92, .numcoi = 3 }, // 208 7.8.113      HCI_LE_ISO_Read_Test_Counters
  { .OCF = 0x73, .isret = 0, .coistart =  89, .numcoi = 3 }, // 209 7.8.114    p HCI_LE_ISO_Test_End
  { .OCF = 0x73, .isret = 1, .coistart =  92, .numcoi = 3 }, // 210 7.8.114      HCI_LE_ISO_Test_End
  { .OCF = 0x74, .isret = 0, .coistart =  89, .numcoi = 3 }, // 211 7.8.115      HCI_LE_Set_Host_Feature
  { .OCF = 0x74, .isret = 1, .coistart =   5, .numcoi = 1 }, // 212 7.8.115    p HCI_LE_Set_Host_Feature
  { .OCF = 0x75, .isret = 0, .coistart =  89, .numcoi = 3 }, // 213 7.8.116    p HCI_LE_Read_ISO_Link_Quality
  { .OCF = 0x75, .isret = 1, .coistart = 115, .numcoi = 5 }, // 214 7.8.116      HCI_LE_Read_ISO_Link_Quality
  ...
  { .OCF = 0x7a, .isret = 0, .coistart = 156, .numcoi = 3 }, // 222 7.8.121      HCI_LE_Set_Transmit_Power_Reporting_Enable
  { .OCF = 0x7a, .isret = 1, .coistart =  24, .numcoi = 2 }, // 223 7.8.121    p HCI_LE_Set_Transmit_Power_Reporting_Enable
  { .OCF = 0x7b, .isret = 0, .coistart = 230, .numcoi = 5 }, // 224 7.8.29       HCI_LE_Transmitter_Test [v4]
  { .OCF = 0x7b, .isret = 1, .coistart =   5, .numcoi = 1 }, // 225 7.8.29     p HCI_LE_Transmitter_Test [v4]
  { .OCF = 0x7c, .isret = 0, .coistart =  89, .numcoi = 3 }, // 226 7.8.122      HCI_LE_Set_Data_Related_Address_Changes
  { .OCF = 0x7c, .isret = 1, .coistart =   5, .numcoi = 1 }, // 227 7.8.122    p HCI_LE_Set_Data_Related_Address_Changes
  { .OCF = 0x7d, .isret = 0, .coistart =  72, .numcoi = 3 }, // 228 7.8.123      HCI_LE_Set_Default_Subrate
  ...
  { .OCF = 0x7f, .isret = 0, .coistart = 177, .numcoi = 6 }, // 231 7.8.53       HCI_LE_Set_Extended_Advertising_Parameters [v2]
  { .OCF = 0x7f, .isret = 1, .coistart =   8, .numcoi = 1 }, // 232 7.8.53       HCI_LE_Set_Extended_Advertising_Parameters [v2]
  { .OCF = 0x82, .isret = 0, .coistart = 211, .numcoi = 7 }, // 233 7.8.125      HCI_LE_Set_Periodic_Advertising_Subevent_Data
  { .OCF = 0x82, .isret = 1, .coistart =   8, .numcoi = 1 }, // 234 7.8.125      HCI_LE_Set_Periodic_Advertising_Subevent_Data
  { .OCF = 0x83, .isret = 0, .coistart = 207, .numcoi = 4 }, // 235 7.8.126      HCI_LE_Set_Periodic_Advertising_Response_Data
  { .OCF = 0x83, .isret = 1, .coistart =  24, .numcoi = 2 }, // 236 7.8.126      HCI_LE_Set_Periodic_Advertising_Response_Data
  { .OCF = 0x84, .isret = 0, .coistart = 151, .numcoi = 5 }, // 237 7.8.127      HCI_LE_Set_Periodic_Sync_Subevent
  { .OCF = 0x84, .isret = 1, .coistart =  24, .numcoi = 2 }, // 238 7.8.127      HCI_LE_Set_Periodic_Sync_Subevent
  { .OCF = 0x85, .isret = 0, .coistart =  65, .numcoi = 7 }, // 239 7.8.66       HCI_LE_Extended_Create_Connection [v2]
  { .OCF = 0x86, .isret = 0, .coistart = 199, .numcoi = 4 }, // 240 7.8.61       HCI_LE_Set_Periodic_Advertising_Parameters [v2]
...
static const CodecTab_t CodecTab_8 = {
  .numtab = 242, .numcoi = 235, .table = TE_8, .CoI = CoI_8
};
