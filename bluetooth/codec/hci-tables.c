...
static const CoI_t CoI_0[204] = {
  ...
  INFO(  7.7.65.2 ,  46) { .num =  5, .skip = 3 }, { .action = loop, .inst = 1 }, { .num =  9, .skip = 3 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .num =  1, .skip = 3 }, { .action = endloop, .inst = 1 }, 
...
static const CoI_t CoI_8[235] = {
  ...
  INFO(   7.8.125 , 211) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  2 }, { .action = loop, .inst = 1 }, { .num =  4 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .action = endloop, .inst = 1 }, 
  ...
  INFO(    7.8.29 , 230) { .num =  1, .skip = 1 }, { .num =  3, .skip = 1 }, { .num =  7, .skip = 3 }, { .action = inlinefix, .arg = 1, .inst = 1 }, { .num =  2, .skip = 2 }, 
};
