...
typedef struct HCI_Accept_Synchronous_Connection_Request_Cmd_t {
  HCI_Cmd_t                Cmd;
  BD_Addr_t                BD_Addr;
...
} HCI_Accept_Synchronous_Connection_Request_Cmd_t;
...
typedef struct HCI_Enhanced_Accept_Synchronous_Connection_Request_Cmd_t {
  HCI_Cmd_t                Cmd;
  BD_Addr_t                BD_Addr;
  uint32_t                 Transmit_Bandwidth;
  uint32_t                 Receive_Bandwidth;
  ...
  uint16_t                 Packet_Type;
  uint8_t                  Retransmission_Effort;
} HCI_Enhanced_Accept_Synchronous_Connection_Request_Cmd_t;
...
typedef struct HCI_Enhanced_Setup_Synchronous_Connection_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint16_t                 Connection_Handle;
  uint32_t                 Transmit_Bandwidth;
  uint32_t                 Receive_Bandwidth;
  ...
  uint16_t                 Packet_Type;
  uint8_t                  Retransmission_Effort;
} HCI_Enhanced_Setup_Synchronous_Connection_Cmd_t;
...
// HCI_LE_Periodic_Advertising_Create_Sync_Cancel_Ret_t only has one member: Status.

// 7.8.67 LE Periodic Advertising Create Sync command

typedef struct HCI_LE_Periodic_Advertising_Create_Sync_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Options;
  uint8_t                  Advertising_SID;
  uint8_t                  Advertiser_Address_Type;
...
} HCI_LE_Periodic_Advertising_Create_Sync_Cmd_t;

// 7.7.65.15 LE Periodic Advertising Report event

typedef struct HCI_LE_Periodic_Advertising_Report_v2_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint16_t                 Sync_Handle;
  uint8_t                  TX_Power;
  ...
  uint8_t                  Data_Length;
  uint8_t                  Data[0];
} HCI_LE_Periodic_Advertising_Report_v2_Evt_t;

typedef struct HCI_LE_Periodic_Advertising_Report_v1_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint16_t                 Sync_Handle;
  uint8_t                  TX_Power;
  ...
  uint8_t                  Data_Length;
  uint8_t                  Data[0];
} HCI_LE_Periodic_Advertising_Report_v1_Evt_t;

// 7.8.90 LE Periodic Advertising Set Info Transfer command

typedef struct HCI_LE_Periodic_Advertising_Set_Info_Transfer_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint16_t                 Connection_Handle;
  uint16_t                 Service_Data;
  uint8_t                  Advertising_Handle;
} HCI_LE_Periodic_Advertising_Set_Info_Transfer_Cmd_t;

// HCI_LE_Periodic_Advertising_Set_Info_Transfer_Ret_t only has one member: Status_Conn.

// 7.7.65.37 LE Periodic Advertising Response Report event

typedef struct HCI_LE_Periodic_Advertising_Response_Report_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint8_t                  Advertising_Handle;
  uint8_t                  Subevent;
...
} HCI_LE_Periodic_Advertising_Response_Report_Evt_t;

// 7.7.65.36 LE Periodic Advertising Subevent Data Request event

typedef struct HCI_LE_Periodic_Advertising_Subevent_Data_Request_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint8_t                  Advertising_Handle;
  uint8_t                  Subevent_Start;
  uint8_t                  Subevent_Data_Count;
} HCI_LE_Periodic_Advertising_Subevent_Data_Request_Evt_t;

// 7.7.65.14 LE Periodic Advertising Sync Established event

typedef struct HCI_LE_Periodic_Advertising_Sync_Established_v2_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint8_t                  Status;
  uint16_t                 Sync_Handle;
...
} HCI_LE_Periodic_Advertising_Sync_Established_v2_Evt_t;

typedef struct HCI_LE_Periodic_Advertising_Sync_Established_v1_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint8_t                  Status;
  uint16_t                 Sync_Handle;
  ...
  uint16_t                 Periodic_Advertising_Interval;
  uint8_t                  Advertiser_Clock_Accuracy;
} HCI_LE_Periodic_Advertising_Sync_Established_v1_Evt_t;

// 7.7.65.16 LE Periodic Advertising Sync Lost event

typedef struct HCI_LE_Periodic_Advertising_Sync_Lost_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint16_t                 Sync_Handle;
} HCI_LE_Periodic_Advertising_Sync_Lost_Evt_t;

// 7.8.89 LE Periodic Advertising Sync Transfer command

typedef struct HCI_LE_Periodic_Advertising_Sync_Transfer_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint16_t                 Connection_Handle;
  uint16_t                 Service_Data;
  uint16_t                 Sync_Handle;
} HCI_LE_Periodic_Advertising_Sync_Transfer_Cmd_t;

// HCI_LE_Periodic_Advertising_Sync_Transfer_Ret_t only has one member: Status_Conn.

// 7.7.65.24 LE Periodic Advertising Sync Transfer Received event

typedef struct HCI_LE_Periodic_Advertising_Sync_Transfer_Received_v2_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint8_t                  Status;
  uint16_t                 Connection_Handle;
  ...
  uint8_t                  Response_Slot_Delay;
  uint8_t                  Response_Slot_Spacing;
} HCI_LE_Periodic_Advertising_Sync_Transfer_Received_v2_Evt_t;

typedef struct HCI_LE_Periodic_Advertising_Sync_Transfer_Received_v1_Evt_t {
  HCI_Evt_t                Evt;
  uint8_t                  Subevent_Code;
  uint8_t                  Status;
  uint16_t                 Connection_Handle;
  ...
  uint16_t                 Periodic_Advertising_Interval;
  uint8_t                  Advertiser_Clock_Accuracy;
} HCI_LE_Periodic_Advertising_Sync_Transfer_Received_v1_Evt_t;

// 7.8.69 LE Periodic Advertising Terminate Sync command

typedef struct HCI_LE_Periodic_Advertising_Terminate_Sync_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint16_t                 Sync_Handle;
} HCI_LE_Periodic_Advertising_Terminate_Sync_Cmd_t;

// HCI_LE_Periodic_Advertising_Terminate_Sync_Ret_t only has one member: Status.
...
typedef struct HCI_LE_Set_Advertising_Set_Random_Address_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Advertising_Handle;
  BD_Addr_t                Random_Address;
} HCI_LE_Set_Advertising_Set_Random_Address_Cmd_t;

// HCI_LE_Set_Advertising_Set_Random_Address_Ret_t only has one member: Status.
...
typedef struct HCI_LE_Set_Default_Periodic_Advertising_Sync_Transfer_Parameters_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Mode;
  uint16_t                 Skip;
  uint16_t                 Sync_Timeout;
  uint8_t                  CTE_Type;
} HCI_LE_Set_Default_Periodic_Advertising_Sync_Transfer_Parameters_Cmd_t;

// HCI_LE_Set_Default_Periodic_Advertising_Sync_Transfer_Parameters_Ret_t only has one member: Status.
...
typedef struct HCI_LE_Set_Periodic_Advertising_Data_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Advertising_Handle;
  uint8_t                  Operation;
  uint8_t                  Advertising_Data_Length;
  uint8_t                  Advertising_Data[0];
} HCI_LE_Set_Periodic_Advertising_Data_Cmd_t;

// HCI_LE_Set_Periodic_Advertising_Data_Ret_t only has one member: Status.

// 7.8.63 LE Set Periodic Advertising Enable command

typedef struct HCI_LE_Set_Periodic_Advertising_Enable_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Enable;
  uint8_t                  Advertising_Handle;
} HCI_LE_Set_Periodic_Advertising_Enable_Cmd_t;

// HCI_LE_Set_Periodic_Advertising_Enable_Ret_t only has one member: Status.

// 7.8.61 LE Set Periodic Advertising Parameters command

typedef struct HCI_LE_Set_Periodic_Advertising_Parameters_v2_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Advertising_Handle;
...
} HCI_LE_Set_Periodic_Advertising_Parameters_v2_Cmd_t;

typedef struct HCI_LE_Set_Periodic_Advertising_Parameters_v2_Ret_t {
  HCI_Evt_t                Evt;
  uint8_t                  Status;
  uint8_t                  Advertising_Handle;
} HCI_LE_Set_Periodic_Advertising_Parameters_v2_Ret_t;

typedef struct HCI_LE_Set_Periodic_Advertising_Parameters_v1_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Advertising_Handle;
  uint16_t                 Periodic_Advertising_Interval_Min;
  uint16_t                 Periodic_Advertising_Interval_Max;
  uint16_t                 Periodic_Advertising_Properties;
} HCI_LE_Set_Periodic_Advertising_Parameters_v1_Cmd_t;

// HCI_LE_Set_Periodic_Advertising_Parameters_v1_Ret_t only has one member: Status.

// 7.8.88 LE Set Periodic Advertising Receive Enable command

typedef struct HCI_LE_Set_Periodic_Advertising_Receive_Enable_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint16_t                 Sync_Handle;
  uint8_t                  Enable;
} HCI_LE_Set_Periodic_Advertising_Receive_Enable_Cmd_t;

// HCI_LE_Set_Periodic_Advertising_Receive_Enable_Ret_t only has one member: Status.

// 7.8.126 LE Set Periodic Advertising Response Data command

typedef struct HCI_LE_Set_Periodic_Advertising_Response_Data_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint16_t                 Sync_Handle;
...
} HCI_LE_Set_Periodic_Advertising_Response_Data_Cmd_t;

typedef struct HCI_LE_Set_Periodic_Advertising_Response_Data_Ret_t {
  HCI_Evt_t                Evt;
  uint8_t                  Status;
  uint16_t                 Sync_Handle;
} HCI_LE_Set_Periodic_Advertising_Response_Data_Ret_t;

// 7.8.125 LE Set Periodic Advertising Subevent Data command

typedef struct HCI_LE_Set_Periodic_Advertising_Subevent_Data_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Advertising_Handle;
  uint8_t                  Num_Subevents;
  struct {
...
} HCI_LE_Set_Periodic_Advertising_Subevent_Data_Cmd_t;

typedef struct HCI_LE_Set_Periodic_Advertising_Subevent_Data_Ret_t {
  HCI_Evt_t                Evt;
  uint8_t                  Status;
  uint8_t                  Advertising_Handle;
} HCI_LE_Set_Periodic_Advertising_Subevent_Data_Ret_t;
...
typedef struct HCI_LE_Set_Periodic_Advertising_Sync_Transfer_Parameters_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint16_t                 Connection_Handle;
  uint8_t                  Mode;
  uint16_t                 Skip;
  uint16_t                 Sync_Timeout;
  uint8_t                  CTE_Type;
} HCI_LE_Set_Periodic_Advertising_Sync_Transfer_Parameters_Cmd_t;

// HCI_LE_Set_Periodic_Advertising_Sync_Transfer_Parameters_Ret_t only has one member: Status_Conn.
...
typedef struct HCI_Read_Synchronous_Flow_Control_Enable_Ret_t {
  HCI_Evt_t                Evt;
  uint8_t                  Status;
  uint8_t                  Synchronous_Flow_Control_Enable;
} HCI_Read_Synchronous_Flow_Control_Enable_Ret_t;
...
typedef struct HCI_Reject_Synchronous_Connection_Request_Cmd_t {
  HCI_Cmd_t                Cmd;
  BD_Addr_t                BD_Addr;
  uint8_t                  Reason;
} HCI_Reject_Synchronous_Connection_Request_Cmd_t;
...
typedef struct HCI_Setup_Synchronous_Connection_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint16_t                 Connection_Handle;
  uint32_t                 Transmit_Bandwidth;
  uint32_t                 Receive_Bandwidth;
  ...
  uint8_t                  Retransmission_Effort;
  uint16_t                 Packet_Type;
} HCI_Setup_Synchronous_Connection_Cmd_t;
...
typedef struct HCI_Synchronous_Connection_Changed_Evt_t {
  HCI_Evt_t                Evt;
  Status_Conn_Handle_t     Status_Conn;
...
} HCI_Synchronous_Connection_Changed_Evt_t;

// 7.7.35 Synchronous Connection Complete event

typedef struct HCI_Synchronous_Connection_Complete_Evt_t {
  HCI_Evt_t                Evt;
  Status_Conn_Handle_t     Status_Conn;
  BD_Addr_t                BD_Addr;
  uint8_t                  Link_Type;
  ...
  uint16_t                 TX_Packet_Length;
  uint8_t                  Air_Mode;
} HCI_Synchronous_Connection_Complete_Evt_t;
...
typedef struct HCI_Write_Synchronous_Flow_Control_Enable_Cmd_t {
  HCI_Cmd_t                Cmd;
  uint8_t                  Synchronous_Flow_Control_Enable;
} HCI_Write_Synchronous_Flow_Control_Enable_Cmd_t;

// HCI_Write_Synchronous_Flow_Control_Enable_Ret_t only has one member: Status.
